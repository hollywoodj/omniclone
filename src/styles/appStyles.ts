...
export const appStyles = StyleSheet.create({
  ...
  noteGlyph: { marginLeft: 6, width: 14, height: 16, alignItems: "center", justifyContent: "center" },
  flaggedForecastRow: { backgroundColor: "#fbf6ea" },
  attachmentEmpty: { flex: 1, paddingHorizontal: 18, paddingTop: 18 },
  attachmentIcon: { width: 52, height: 52, marginBottom: 12, alignItems: "center", justifyContent: "center", borderRadius: 26, borderWidth: 1.5, borderColor: "#cfcdd2", alignSelf: "center" },
  attachmentTitle: { marginBottom: 6, fontSize: 15, fontWeight: "700", color: "#67636a", textAlign: "center" },
  attachmentText: { fontSize: 11, lineHeight: 16, textAlign: "center", color: "#8f8b93" },
  attachmentList: { gap: 6, marginBottom: 14 },
  attachmentRow: { minHeight: 36, paddingHorizontal: 10, flexDirection: "row", alignItems: "center", gap: 8, borderRadius: 10, borderWidth: StyleSheet.hairlineWidth, borderColor: palette.line, backgroundColor: palette.surface },
  attachmentRowCopy: { flex: 1 },
  attachmentName: { fontSize: 12, fontWeight: "600", color: palette.text },
  attachmentUrl: { fontSize: 10, color: palette.muted },
  attachmentAddRow: { flexDirection: "row", gap: 6, alignItems: "center" },
  attachmentInput: { flex: 1, minHeight: 32, paddingHorizontal: 10, borderWidth: StyleSheet.hairlineWidth, borderColor: palette.line, borderRadius: 8, backgroundColor: palette.surface, fontSize: 12, color: palette.text },
