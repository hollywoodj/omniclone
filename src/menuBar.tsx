...
import { shortcutLabel as platformShortcut } from "./shortcuts.ts";
  ...
  return [
    {
      ...
      items: [
        ...
        { id: "settings", label: "Settings…", shortcut: platformShortcut("⌘,"), command: { type: "openSettings" } },
      ],
    },
    {
      id: "file",
      label: "File",
      items: [
        { id: "new-action", label: "New Action", shortcut: platformShortcut("⌘N"), command: { type: "newAction" } },
        { id: "new-project", label: "New Project", shortcut: platformShortcut("⇧⌘N"), command: { type: "newProject" } },
        { id: "new-folder", label: "New Folder", shortcut: platformShortcut("⌥⌘N"), command: { type: "newFolder" } },
        { id: "quick-entry", label: "Quick Entry", shortcut: platformShortcut("⌃⌥Space"), command: { type: "quickEntry" } },
        { id: "sep-file", separator: true },
        { id: "quick-open", label: "Quick Open…", shortcut: platformShortcut("⌘O"), command: { type: "quickOpen" } },
        ...
        { id: "print", label: "Print…", shortcut: platformShortcut("⌘P"), command: { type: "print" } },
      ],
    },
    {
      id: "edit",
      label: "Edit",
      items: [
        { id: "select-all", label: "Select All", shortcut: platformShortcut("⌘A"), command: { type: "selectAll" } },
        { id: "duplicate", label: "Duplicate", shortcut: platformShortcut("⌘D"), command: { type: "duplicate" } },
        { id: "undo", label: "Undo", shortcut: platformShortcut("⌘Z"), command: { type: "undo" } },
        { id: "redo", label: "Redo", shortcut: platformShortcut("⇧⌘Z"), command: { type: "redo" } },
        { id: "sep-edit", separator: true },
        { id: "copy-paper", label: "Copy as TaskPaper", shortcut: platformShortcut("⇧⌘C"), command: { type: "copyTaskPaper" } },
        { id: "paste-paper", label: "Paste", shortcut: platformShortcut("⌘V"), command: { type: "pasteTaskPaper" } },
        { id: "sep-find", separator: true },
        { id: "find", label: "Find", shortcut: platformShortcut("⌘F"), command: { type: "toggleSearch" } },
        { id: "find-next", label: "Find Next", shortcut: platformShortcut("⌘G"), command: { type: "findNext" } },
        { id: "find-prev", label: "Find Previous", shortcut: platformShortcut("⇧⌘G"), command: { type: "findPrevious" } },
      ],
    },
    {
      id: "view",
      label: "View",
      items: [
        { id: "view-options", label: options.viewOptionsOpen ? "Hide View Options" : "Show View Options", shortcut: platformShortcut("⇧⌘V"), command: { type: "toggleViewMenu" } },
        { id: "sep-view-1", separator: true },
        { id: "sidebar", label: options.sidebarOpen ? "Hide Sidebar" : "Show Sidebar", shortcut: platformShortcut("⌥⌘S"), command: { type: "toggleSidebar" } },
        { id: "inspector", label: options.inspectorOpen ? "Hide Inspector" : "Show Inspector", shortcut: platformShortcut("⌥⌘I"), command: { type: "toggleInspector" } },
        { id: "bar", label: options.perspectiveBarVisible ? "Hide Perspectives Bar" : "Show Perspectives Bar", shortcut: platformShortcut("⌥⌘P"), command: { type: "togglePerspectivesBar" } },
        ...
        { id: "back", label: "Go Back", shortcut: platformShortcut("⌘["), command: { type: "goBack" } },
        { id: "forward", label: "Go Forward", shortcut: platformShortcut("⌘]"), command: { type: "goForward" } },
        { id: "sep-view-3", separator: true },
        { id: "expand", label: "Expand All", shortcut: platformShortcut("⌥⌘9"), command: { type: "expandAll" } },
        { id: "collapse", label: "Collapse All", shortcut: platformShortcut("⌥⌘0"), command: { type: "collapseAll" } },
    ...
    },
    {
      ...
      label: "Organize",
      items: [
        { id: "clean-up", label: "Clean Up", shortcut: platformShortcut("⌘K"), command: { type: "cleanUp" } },
        { id: "sep-org-1", separator: true },
        { id: "indent", label: "Indent", shortcut: "⇥", command: { type: "indent" } },
        { id: "outdent", label: "Outdent", shortcut: platformShortcut("⇧⇥"), command: { type: "outdent" } },
        ...
        { id: "move-up", label: "Move Up", shortcut: platformShortcut("⌥⌘↑"), command: { type: "moveRow", direction: "up" } },
        { id: "move-down", label: "Move Down", shortcut: platformShortcut("⌥⌘↓"), command: { type: "moveRow", direction: "down" } },
        { id: "sep-org-2", separator: true },
        { id: "expand-org", label: "Expand All", shortcut: platformShortcut("⌥⌘9"), command: { type: "expandAll" } },
        { id: "collapse-org", label: "Collapse All", shortcut: platformShortcut("⌥⌘0"), command: { type: "collapseAll" } },
      ],
    },
    {
      id: "perspectives",
      label: "Perspectives",
      items: [
        { id: "list", label: "Show Perspectives List", shortcut: platformShortcut("⌃⌘P"), command: { type: "showPerspectivesList" } },
